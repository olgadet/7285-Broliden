...
- check data against files sent by Alexandra, on 2024-05-08
...
# select columns
cols_v2_v3 <- c("PatIDPx", "PatID", 
                "age", "Nugent_Score_v2","Nugent_Score_v3",
                "BV_Diagnosis_v2...14", "BV_Diagnosis_v3...16",
...
## Import new data (2024-05-08)
```{r}
# data from Alexandra
df_v3 <- read_xlsx("../data/raw/2024-05-08/Filtered_Metadata_ BV-project_V3 (FOL)_updated_2024-05-08.xlsx", 
                   col_types = c("text", "text", "numeric", "numeric", "numeric", "numeric")) %>%
    rename(BV_v3 = BV_Diagnosis_v3, 
           E2_v3 = Plasma_S_Estradiol_pg_mL_v3, 
           P4_v3 = Plasma_S_Prog_ng_mL_v3)


df_v2 <- read_xlsx("../data/raw/2024-05-08/Filtered_metadata_ BV-project_V2 (LUT)_updated_2024-05-08.xlsx", 
                   col_types = c("text", "text", "numeric", "numeric", "numeric", "numeric")) %>%
  rename(BV_v2 = BV_Diagnosis_v2, 
         E2_v2 = `Conc_Estradiol_v2 pg/ml`, 
         P4_v2 = `Conc_Progesteron_v2 ng/ml`)
